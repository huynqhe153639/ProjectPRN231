    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuizAttendance", x => x.AttendanceId);
                    table.ForeignKey(
                        name: "FK_QuizAttendance_AspNetUsers_StudentId",
                        column: x => x.StudentId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentAssignment", x => x.SubmissionId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuizAttendance_StudentId",
